...
3. Choose category, difficulty, and question mode (`open_ended` or `multiple_choice`)
4. Play trivia with voice interaction via OpenAI Realtime API
5. Submit answers by saying `final answer, ...`
6. Score tracking and preference-aware rounds
