...
describe("sessionStore", () => {
    ...
    it("update merges partial patches", () => {
        ...
        const updated = store.update(444444, { state: "AWS_ACCOUNT_CHECK" });
    ...
    it("throws on update for nonexistent user", () => {
        expect(() => store.update(888888, { state: "DEPLOY" })).toThrow("No session for user 888888");
    });
    ...
    it("sets updatedAt on update", () => {
        ...
        const s2 = store.update(123123, { state: "AWS_ACCOUNT_CHECK" });
